...
export class Launcher extends React.Component {
    ...
    onLaunch() {
        const seconds = this.parseTime(this.state.time);
    ...
    parseTime(t) {
        ...
        if (parts.length > 1) {
            const value = this.parseTime(parts[0]);
                ...
                <div className="col-xs-12">
                    <div className="col-xs-5">
                        ...
                        <div className="col-xs-8">
                            <input
                                className="form-control input-sm" type="text" name="counter-name"
                    ...
                    <div className="col-xs-2">
                        <button
                            onClick={this.onLaunch.bind(this)}
